...
public class UserRegistration extends JFrame {
    ...
    public UserRegistration() {
        ...
        JLabel lblNewUserRegister = new JLabel("Indigo Airlines");
        lblNewUserRegister.setFont(new Font("Times New Roman", Font.BOLD, 42));
        lblNewUserRegister.setForeground(new java.awt.Color(0, 0, 255));
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/indigo", "root", "");
